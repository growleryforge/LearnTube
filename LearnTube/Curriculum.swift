...
enum Curriculum {
    ...
    static let teachNotes: [String: String] = [
        ...
        "G1-R9": "Some words you just know by sight: were, after, again, every, could, when. Read the sentence and drag in the one that fits.",
        "K-R16": "Every word starts with a sound. Goat starts with /g/, so it goes to G!",
        ...
        "K-R15": "Baby animals have special names. A baby sheep is a lamb, a baby horse is a foal, a baby pig is a piglet, a baby duck is a duckling.",
        ...
        "K-S22": "A plant has parts with jobs: roots drink water, leaves catch sun, flowers make seeds, and fruit holds the seeds. Carrots are roots we eat!",
        ...
        "K-R5": "To read a word, blend the sounds together: c-a-t makes 'cat'. Then carry the sounds to the picture.",
        "K-R6": "Star words like see, go, is, like, and 'and' pop up in every sentence. Read the whole sentence and drag in the word that makes sense.",
        "K-R7": "Stories happen in order. Think about what happened FIRST, then next, then last.",
        "K-R8": "We read the words from left to right, top to bottom. Put the words in that order.",
        ...
        "FR-M13": "The bigger number is the one you reach later when counting. 14 is more than 10; 8 is less.",
        ...
        "FR-R1": "Read the word on each pen, then carry the picture over to it. c-a-t is cat! 🐱",
        "FR-R2": "Stretch each sound and blend: h-e-n is hen. Then carry the picture to that word.",
        ...
        "FR-R6": "Read the whole sentence, then drag the missing word into the gap. A fish can swim, not jump.",
        "FR-R7": "Listen to each little sentence and think: could that really happen? If yes, it's true. If not, it's silly!",
